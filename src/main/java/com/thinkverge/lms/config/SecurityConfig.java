    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // ── Modules ───────────────────────────────────────────
                .requestMatchers(HttpMethod.GET, "/api/modules/**").hasAnyRole("STUDENT", "INSTRUCTOR", "ADMIN")
                .requestMatchers("/api/modules/**").hasAnyRole("INSTRUCTOR", "ADMIN")
                ...
                .requestMatchers(HttpMethod.DELETE, "/api/public/feedback/*").hasRole("ADMIN")
                .requestMatchers(HttpMethod.GET, "/api/public/feedback/pending").hasRole("ADMIN")
                .requestMatchers(HttpMethod.POST,   "/api/users/profile-image").hasAnyRole("ADMIN", "INSTRUCTOR", "STUDENT")
                .requestMatchers(HttpMethod.PUT,    "/api/users/profile").hasAnyRole("ADMIN", "INSTRUCTOR", "STUDENT")
                .requestMatchers(HttpMethod.DELETE, "/api/users/profile-image").hasAnyRole("ADMIN", "INSTRUCTOR", "STUDENT")
                .requestMatchers("/api/users/**").hasAnyRole("ADMIN", "INSTRUCTOR", "STUDENT")
                ...
                // ── Assignments ───────────────────────────────────────
                .requestMatchers(HttpMethod.GET, "/api/assignments/**").hasAnyRole("STUDENT", "INSTRUCTOR", "ADMIN")
                .requestMatchers("/api/assignments/**").hasAnyRole("INSTRUCTOR", "ADMIN")

                // ── Submissions ───────────────────────────────────────
                .requestMatchers(HttpMethod.GET,    "/api/submissions/my").hasAnyRole("STUDENT", "INSTRUCTOR", "ADMIN")
                ...
                .requestMatchers(HttpMethod.GET,    "/api/submissions/assignment/**").hasAnyRole("INSTRUCTOR", "ADMIN")
                .requestMatchers(HttpMethod.PUT,    "/api/submissions/*/grade").hasAnyRole("INSTRUCTOR", "ADMIN")

                // ── Quizzes ───────────────────────────────────────────
                .requestMatchers(HttpMethod.GET,  "/api/quizzes/module/*/instructor").hasAnyRole("INSTRUCTOR", "ADMIN")
                .requestMatchers(HttpMethod.GET,  "/api/quizzes/module-status/**").hasAnyRole("STUDENT", "INSTRUCTOR", "ADMIN")
                .requestMatchers(HttpMethod.GET,  "/api/quizzes/module/**").hasAnyRole("STUDENT", "INSTRUCTOR", "ADMIN")
                .requestMatchers(HttpMethod.GET,  "/api/quizzes/final/course/*/instructor").hasAnyRole("INSTRUCTOR", "ADMIN")
                .requestMatchers(HttpMethod.GET,  "/api/quizzes/final/**").hasAnyRole("STUDENT", "INSTRUCTOR", "ADMIN")
                .requestMatchers(HttpMethod.POST, "/api/quizzes/final").hasAnyRole("INSTRUCTOR", "ADMIN")
                .requestMatchers(HttpMethod.GET,  "/api/quizzes/my/**").hasAnyRole("STUDENT", "INSTRUCTOR", "ADMIN")
                .requestMatchers(HttpMethod.POST, "/api/quizzes/submit").hasRole("STUDENT")
                .requestMatchers(HttpMethod.POST, "/api/quizzes").hasAnyRole("INSTRUCTOR", "ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/quizzes/**").hasAnyRole("INSTRUCTOR", "ADMIN")
                ...
                // ── AI Messages ───────────────────────────────────────
                .requestMatchers(HttpMethod.POST,   "/api/messages/ai/ask").hasAnyRole("STUDENT", "INSTRUCTOR")
                .requestMatchers(HttpMethod.GET,    "/api/messages/ai/**").hasAnyRole("STUDENT", "INSTRUCTOR")
                .requestMatchers(HttpMethod.DELETE, "/api/messages/ai/clear/**").hasAnyRole("STUDENT", "INSTRUCTOR")

                // ── Direct Messages (clear & single delete) ───────────
                .requestMatchers(HttpMethod.DELETE, "/api/messages/direct/clear/**").hasAnyRole("STUDENT", "INSTRUCTOR")
                .requestMatchers(HttpMethod.DELETE, "/api/messages/**").hasAnyRole("STUDENT", "INSTRUCTOR")
